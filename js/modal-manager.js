class ModalManager {
    ...
    // Создаем точки-индикаторы для пагинации
    createPagination() {
        ...
        paginationContainer.innerHTML = ''; // Очищаем предыдущие точки
    ...
    updatePagination() {
        const dots = this.lightbox.querySelectorAll('.lightbox-pagination-dot');
